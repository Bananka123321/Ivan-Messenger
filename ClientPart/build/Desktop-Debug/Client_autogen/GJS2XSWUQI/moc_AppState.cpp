...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AppState_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AppState_t qt_meta_stringdata_AppState = {
    {
        QT_MOC_LITERAL(0, 8),  // "AppState"
        QT_MOC_LITERAL(9, 12),  // "usersChanged"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 24),  // "std::vector<std::string>"
        QT_MOC_LITERAL(48, 5)   // "users"
    },
    "AppState",
    "usersChanged",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_AppState[] = {
...
Q_CONSTINIT const QMetaObject AppState::staticMetaObject = { {
    ...
    qt_meta_stringdata_AppState.offsetsAndSizes,
...
void AppState::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->usersChanged((*reinterpret_cast< std::add_pointer_t<std::vector<std::string>>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AppState::*)(const std::vector<std::string> & );
            if (_t _q_method = &AppState::usersChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AppState::usersChanged(const std::vector<std::string> & _t1)
{
