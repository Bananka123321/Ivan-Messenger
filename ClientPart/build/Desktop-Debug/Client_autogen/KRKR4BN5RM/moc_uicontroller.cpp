...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_UIController_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_UIController_t qt_meta_stringdata_UIController = {
    {
        QT_MOC_LITERAL(0, 12)   // "UIController"
    },
    "UIController"
};
...
Q_CONSTINIT static const uint qt_meta_data_UIController[] = {
...
Q_CONSTINIT const QMetaObject UIController::staticMetaObject = { {
    ...
    qt_meta_stringdata_UIController.offsetsAndSizes,
    qt_meta_data_UIController,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_UIController_t,
        // Q_OBJECT / Q_GADGET
